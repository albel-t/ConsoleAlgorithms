/****
Структура содержит приватные поля и публичные методы для работы с ними. Внутри так же существует приватная структура для создания заказов на бронирование. Часть параметров создается в ручную, часть заполняется рандомно.
